...
export default function Contactus() {
  ...
  const [formRef, inView] = useInView({ triggerOnce: true });
  ...
  useEffect(() => {
    if (inView) {
      // Perform animations or actions when form comes into view
    }
  }, [inView]);

  return (
    <section className="body-font relative text-gray-400">
      <div className="container mx-auto px-5 py-24" ref={formRef}>
        <motion.div
